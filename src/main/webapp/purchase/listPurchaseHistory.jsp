				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
					...
					<tr>
						<td align="center">
							...
							<a href="/listPurchaseHistory.do?historyPage=${historyPaging.start - 1 }" 
							${(paging.left)? "":"class='disabled'" }>
								<span>이전</span>
							</a>
							...
							<c:forEach begin="${historyPaging.start }" end="${historyPaging.end }" varStatus="status">
								...
								<a href="/listPurchaseHistory.do?historyPage=${status.count }" 
							...
							<a href="/listPurchaseHistory.do?historyPage=${historyPaging.end + 1 }" 
							...
							<a href="/listPurchaseHistory.do?historyPage=${historyPaing.totalPage }" 
							${(paging.right)? "":"class='disabled'" }>
								<span>▶</span>
							</a>
